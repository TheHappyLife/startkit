...
export enum Format {
  DATE_BEFORE_MONTH = "dd MMM, yyyy", // 12 May, 2025
  DATE_AFTER_MONTH = "MMM dd, yyyy", // May 12, 2025
  DATE_AFTER_MONTH_WITH_TIME = "MMM dd, yyyy '-' HH:mm:ss", // 12 May, 2025 - 12:00:00
  DATE_BEFORE_MONTH_WITH_TIME = "dd MMM, yyyy '-' HH:mm:ss", // 12 May, 2025 - 12:00:00
